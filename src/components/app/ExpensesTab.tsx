                    ...
                    <CardContent className="space-y-4 pt-5">
                      {recurring.length === 0 ? (
                        <p className="py-2 text-center text-sm text-muted-foreground">
                          Nothing recurring yet. Rent and salaries get added automatically each
                          month.
                        </p>
                      ) : (
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex shrink-0 items-center gap-1">
                                  ...
                                  >
                                    <Power
                                      className={r.is_active ? "size-4 text-success" : "size-4"}
                                    />
                                  </Button>
                                  <ConfirmDeleteButton
                                    size="icon"
                    ...
                    <CardContent className="pt-5">
                      {expenseDate && (
                        <div className="frost-soft mb-3 flex items-center justify-between gap-2 rounded-xl border px-3 py-2 text-sm">
                          <span>
                            Showing{" "}
                            <span className="font-medium">{dateFilteredExpenses.length}</span>{" "}
                            expense
                                ...
                                <div className="flex shrink-0 items-center gap-1">
                                  ...
                                  {e.receipt_path && (
                                    <Button
                                      ...
                                      onClick={() => openReceipt(e.receipt_path!, e.expense_no)}
                                    >

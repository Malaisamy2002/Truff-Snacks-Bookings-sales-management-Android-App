 ...
 * the expense itself.
 */
export function compressReceiptImage(file: File, maxDim = 1400, quality = 0.7): Promise<File> {
  return new Promise((resolve) => {
    ...
    // Image compression is an enhancement, never a reason to reject a
    // receipt. This also covers lightweight webviews and non-DOM consumers
    // where FileReader is unavailable.
